...
Menu.Draggable = true
Menu.Position = UDim2.new(0, game.Players.LocalPlayer:GetMouse().ViewSizeX/2.5, 0, -game.Players.LocalPlayer:GetMouse().ViewSizeY/2)
...
for GetBases,_1 in pairs(workspace:FindFirstChild("Bases"):GetChildren()) do
	if _1:IsA("Model") then
		for BaseStorages,_2 in pairs(_1:FindFirstChild("Blocks"):GetChildren()) do
			...
			game.ReplicatedStorage.PlayerEvents["e"..game.Players.LocalPlayer.UserId].DestroyItem:FireServer(_2)
			end
		end
	end
end
...
for _,Clear in pairs(workspace:GetDescendants()) do BasePart = Clear
	if BasePart:IsA("BasePart") then
		game.ReplicatedStorage.PlayerEvents["e"..game.Players.LocalPlayer.UserId].DestroyItem:FireServer(Clear)
	end
end
end)
...
if workspace:FindFirstChild("Mobs") then
	game.ReplicatedStorage.PlayerEvents["e"..game.Players.LocalPlayer.UserId].DestroyItem:FireServer(workspace.Mobs)
end
end)

RemoveCages.MouseButton1Click:Connect(function()
if workspace:FindFirstChild("Cages") then
	game.ReplicatedStorage.PlayerEvents["e"..game.Players.LocalPlayer.UserId].DestroyItem:FireServer(workspace.Cages)
end
end)
...
for _,Shutdown in pairs(game:GetDescendants()) do Bypass1 = Shutdown Bypass2 = Shutdown Bypass3 = Shutdown Bypass4 = Shutdown
	if Bypass1.Name ~= "PlayerEvents" and Bypass2.Name ~= "e"..game.Players.LocalPlayer.UserId and Bypass3.Name ~= "PlaceItem" and Bypass4.Name ~= "DestroyItem" then
		game.ReplicatedStorage.PlayerEvents["e"..game.Players.LocalPlayer.UserId].DestroyItem:FireServer(Shutdown)
	end
end
end)
...
for i,v in pairs(GetPlayer(Victim.Text)) do
	if game.Players:FindFirstChild(v) then
		game.ReplicatedStorage.PlayerEvents["e"..game.Players.LocalPlayer.UserId].DestroyItem:FireServer(game.Players:FindFirstChild(v))
	end
end
end)
...
for i,v in pairs(GetPlayer(Victim.Text)) do
	...
	game.ReplicatedStorage.PlayerEvents["e"..game.Players.LocalPlayer.UserId].DestroyItem:FireServer(game.Players[v].Character.Torso.Neck)
				end
			elseif game.Players[v].Character:FindFirstChild("UpperTorso") then
				game.ReplicatedStorage.PlayerEvents["e"..game.Players.LocalPlayer.UserId].DestroyItem:FireServer(game.Players[v].Character.UpperTorso)
			end
		end
	end
end
...
for i,v in pairs(GetPlayer(Victim.Text)) do
	if game.Players:FindFirstChild(v) then
		if game.Players:FindFirstChild(v).Character then
			game.ReplicatedStorage.PlayerEvents["e"..game.Players.LocalPlayer.UserId].DestroyItem:FireServer(game.Players[v].Character)
		end
	end
end
end)
	...
	if game.Players:FindFirstChild(v) then
		if game.Players:FindFirstChild(v).Character then
			if game.Players:FindFirstChild(v).Character:FindFirstChild("Humanoid") then
				game.ReplicatedStorage.PlayerEvents["e"..game.Players.LocalPlayer.UserId].DestroyItem:FireServer(game.Players[v].Character.Humanoid)
			end
		end
	end
end
...
local PointInfo = function(X,Y)
    local RayA = Camera:ScreenPointToRay(X,Y); local RayB = Ray.new(RayA.Origin, RayA.Direction * 1.0e3)
...
game.ReplicatedStorage.PlayerEvents["e"..game.Players.LocalPlayer.UserId].PlaceItem:FireServer(game.Players.LocalPlayer:GetMouse().Target.CFrame+Vector3.new(0,game.Players.LocalPlayer:GetMouse().Target.Size.Y,0),game.Players.LocalPlayer:GetMouse().Target)
end)
...
Moving = false
game.ReplicatedStorage.PlayerEvents["e"..game.Players.LocalPlayer.UserId].DestroyItem:FireServer(Target)
game.ReplicatedStorage.PlayerEvents["e"..game.Players.LocalPlayer.UserId].PlaceItem:FireServer(Target.CFrame,Target)
end)
...
game.ReplicatedStorage.PlayerEvents["e"..game.Players.LocalPlayer.UserId].DestroyItem:FireServer(game.Players.LocalPlayer:GetMouse().Target)
end)
...
game.ReplicatedStorage.PlayerEvents["e"..game.Players.LocalPlayer.UserId].PlaceItem:FireServer(CFrame.new(Initialize_Coordinates.Initialize_XCoordinate,Initialize_Coordinates.Initialize_YCoordinate,Initialize_Coordinates.Initialize_ZCoordinate),game.Players.LocalPlayer.Character:FindFirstChild("Head"))
end
